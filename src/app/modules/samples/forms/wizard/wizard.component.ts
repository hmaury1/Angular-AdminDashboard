...
export class WizardComponent implements OnInit, OnChanges, AfterViewInit {
    ...
    ngOnInit() {
        this.type = this.formBuilder.group({
            // To add a validator, we must first convert the string value into an array. The first item in the
            // array is the default value if any, then the next item in the array is the validator.
        ...
        $('#wizard-picture').change(function () {
            ...
            if (input[0].files && input[0].files[0]) {
                ...
                // reader.onload = function (e: FileReaderEvent, ef: FileReaderProgressEvent): any {
