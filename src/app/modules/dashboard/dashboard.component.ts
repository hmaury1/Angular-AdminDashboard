...
import { TableData } from '../widgets/md/md-table/md-table.component';
import { LegendItem, ChartType } from '../widgets/md/md-chart/md-chart.component';
...
export class DashboardComponent implements OnInit  {
  ...
  public ngOnInit() {
      this.client.saveCurrentOption(null);
      this.tableData = {
